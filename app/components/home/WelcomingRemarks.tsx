...
function WelcomingRemarks() {
  return (
    <section className="w-full bg-gradient-to-b from-red-bright to-red-dark flex flex-col items-center justify-center py-10 px-12 lg:px-0 gap-8 min-h-[80vh]">
      ...
      <p className="flex flex-col gap-4 lg:max-w-1/2 font-plus-jakarta md:text-xl text-justify font-medium">
        ...
        <span className="text-justify block">
          For 15 years, JMUN has been more than just a conference—it has been a
          global platform for young leaders to redefine international dialogue.
          This year, we stand at a turning point in time, and our theme,
          “Changing the Global Status Quo to Forge a Unified Future,” calls on
          all of us to critically examine the world we live in and the legacies
          we choose to uphold.
        </span>
        <span className="text-justify block">
          ...
          Councils, Specialized Agencies, and Crisis Committee will push you to
          reimagine governance and craft policies that are both ambitious and
          achievable.
        </span>
        <span className="text-justify block">
          But JMUN is not just about debate—it is about building a global
          community. It is about the late-night strategy talks, the friendships
          that transcend borders, and the moments that inspire you to see
          diplomacy as a force for real change.
        </span>
        <span className="text-justify block">
        ...
        <span className="text-justify block">
          ...
          the stances you take, and the words you choose can shape the future of
          diplomacy.
        </span>
        <span className="text-justify block">
